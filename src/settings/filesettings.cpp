...
void TFileSettings::loadSettingsFor(const QString& filename, MediaSettings& mset, int player) {
...
void TFileSettings::saveSettingsFor(const QString& filename, MediaSettings & mset, int player) {
