...
TMenuRotate::TMenuRotate(QWidget* parent, TCore* c)
	...
	new TActionGroupItem(this, group, "rotate_cw_flip", QT_TR_NOOP("&Rotate 90 degrees clockwise and flip"), TMediaSettings::Clockwise_flip);
	new TActionGroupItem(this, group, "rotate_cw", QT_TR_NOOP("Rotate 90 degrees &clockwise"), TMediaSettings::Clockwise);
	new TActionGroupItem(this, group, "rotate_cc", QT_TR_NOOP("Rotate 90 degrees counterclock&wise"), TMediaSettings::Counterclockwise);
	new TActionGroupItem(this, group, "rotate_cc_flip", QT_TR_NOOP("Rotate 90 degrees counterclockwise and &flip"), TMediaSettings::Counterclockwise_flip);
